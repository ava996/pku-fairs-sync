...
每**周日 20:00（北京时间）**自动拉取北京大学就业指导服务中心宣讲会数据，过滤 2026-09-01 及之后的场次，按真实公司名去重，基于用户偏好（互联网/AI 头部、央国企、银行金融、外企关注名单；岗位：产品经理/管培生）标注推荐等级，同步到飞书多维表格。

## 架构

```
GitHub Actions (cron 0 12 * * 0 UTC = 周日20:00 北京时间)
        │
        ▼
